...
export interface GetAllRecommendedForWithdrawal {
    X: number;
    Y: number;
    AMOUNT: number;
    CURRENCY: string;
...
export interface GetAllRecommendedForDeposit {
    x: number;
    y: number;
    DEPOSIT: boolean;
}

export type GetAllRecommendedAtms =
    | GetAllRecommendedForWithdrawal
    | GetAllRecommendedForDeposit;
